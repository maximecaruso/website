...
var bilderMax = 37;
var burgerB = false;
var title = ["Projekt 1","Projekt 2","Projekt 3","Projekt 4","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2","Projekt 2"]

$(document).ready(function(){
    for (let i = 0; i<bilderMax; i++){
        $("#projekte").append("<div id='projekt"+i+"' style='margin-top:20vw'></div>");
      $("#projekt"+i).append("<a href='../projekte/"+title[i]+"/"+title[i]+".html'><div class='projektHolder'><img src='../Images/Startseite/start"+(i+1)+".jpg' class='projekte' style=''><p class='title'>"+title[i]+"</p><img src='../Images/keyboard_arrow_right_white_24dp.svg' class='arrow'></div></a>");
    }
